		...
		chomp;
			...
			if ($mode eq "SE"){
	  		...
	  		#my $CMD = "echo $HUMANN_EXEC --input $input_files --bowtie2 /ifs/home/msph/cii/cg2984/software/bowtie2-2.2.9/ --metaphlan /ifs/home/msph/cii/cg2984/software/metaphlan2/ --diamond /ifs/home/msph/cii/cg2984/.local/bin --output $target_dir$sample_name | qsub -S /bin/bash -V -N $sample_name\_humann -l h_vmem=$MEM -o $target_dir -e $target_dir -j y";
	   		my $CMD = "echo $HUMANN_EXEC --input $input_files --bowtie2 ~/ --metaphlan /share/home/cheng/software/metaphlan2 --diamond /share/data/software/diamond/v0.8.38 --taxonomic-profile /share/data/IlluminaData/VIH/Nov17_2016/merged/humann2/Metagenome/kraken.species.revised.chocophlan.withvalue.txt --prescreen-threshold 0 --output $target_dir$sample_name | qsub -S /bin/bash -V -N $sample_name\_humann -l h_vmem=$MEM -o $target_dir -e $target_dir -j y";
			print $CMD, "\n";
