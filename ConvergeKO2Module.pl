...
GetOptions('h' => \(my $help = ''),
	'p=s' => \(my $orthology2pathwayFile = "$fmapPath/FMAP_data/KEGG_orthology2module.txt"),
...
if($help || scalar(@ARGV) == 0) {
	...
	Usage:   perl ConvergeKO2Module.pl all.merged.abundance.KeepID.txt > all.merged.abundance.KeepID.Module.txt
